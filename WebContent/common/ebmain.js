...
function getPopupValue4 (DisplayField,IdField,Multi, stList, stLc)
{
  dialogDisplayField = DisplayField;
  dialogIdField = IdField;
  dialogMulti = Multi;
        ...
        case 2:  // Y/N
          ...
          }else
          {
            ...
            if ( bReturn == true && gaValidation[i][7] == "range" )
            {
              ...
              {
                bReturn = false;
                stAlert += "\n" +gaValidation[i][2] + " must be greater than or equal to " + elems1[0];
              }           
              if ( thisCtrl.value > elems1[1] )
              {
                bReturn = false;
                stAlert += "\n" +gaValidation[i][2] + " must be less than or equal to " + elems1[1];
              }
            }
          }
          break;
