...
public class EpsListener implements HttpSessionListener {
	...
	public void sessionCreated(HttpSessionEvent event) {
		System.out.println("--------> CREATE SESSION " + event.getSession().getId() + " " + new Date());
	}

	@Override
	public void sessionDestroyed(HttpSessionEvent event) {
		System.out.println("--------> DESTROY SESSION " + event.getSession().getId() + " " + new Date());
		Set<Integer> ids = (Set<Integer>) event.getSession().getServletContext().getAttribute("LOG_IN_USERS");
