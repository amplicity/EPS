...
public class EbCraigsList {
	...
	public String processCraigsList(int iType) {
		...
		if (stPid != null && stPid.length() > 0) {
			...
			case 3:
				// stReturn +=
				// this.getTwitterDetail(this.ebEnt.ebUd.request.getParameter("tw"));
				break;
	...
	// private String stWebContent = ""; don't know how to read it ... not
	// important to save anyways.
...
class OutString2 {
	...
	public void addGigsHrefList(String stAdd) {
		/*
		 * if (stAdd.indexOf("cpg/") >= 0 || stAdd.indexOf("eng/") >= 0 ||
