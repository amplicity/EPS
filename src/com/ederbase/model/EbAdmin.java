...
public class EbAdmin {
	...
	public String getDbManagement(ResultSet rsA, HttpServletRequest request) {
		...
		try {
			...
			case 1:
				...
				stReturn = stReturn
				    + "<table border=0><tr><td><a href='./?a="
				    + stA
				    + "&b=2019'>Read Craigslist</a></td>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=1002'>EPS Demo</a></td>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=19'>Send Twitter</a></td>"
				    + "<td>Send a Tweet</td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=20'>Search Follow </a></td>"
				    + "<td>Follow from search result</td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=18'>Twitter Result</a></td>"
				    + "<td>Count followers etc.</td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=8'>Read Email</a></td>"
				    + "<td>Read Email into X25Communications (removes from mailbox)</td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=5'>Fix History</a></td>"
				    + "<td>Fixes: a) mulitple emails from gmail (same foreign refd) b) set person id in COMM c) add NEW COMM to HISTORY  </td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=15'>Search/Follow Twitter</a></td>"
				    + "<td>Twiter: Line 1 # of returns, Line2: # of searches, Line 3: search, Line4: user</td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=16'>Create Full Hourly Stats</a></td>"
				    + "<td>Rebuild MyHourlyTable</td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=17'>Last 2 Hourly Stats</a></td>"
				    + "<td>Only last 2 hours</td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=10'>Fix MailQ</a></td>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=13'>Fix Insert</a></td>"
				    + "<td>Fixes: mailq >x shows all email addreses that cant be sent.</td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=11'>Fix Message Undeliverable</a></td>"
				    + "<td>Fixes: Undeliverable messages need to be flagged</td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=12'>Process 'confirm me' </a></td>"
				    + "<td>Fixes: Exercises and flags those emails that need to be confirmed</td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=9'>Fix Address/Zip</a></td>  "
				    + "<td>Set stZipCity in Address, for display. X25Zip resides in common</td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=6'>Fix Cross Links / Zombies</a></td>"
				    + "<td>Phone/Email if set in both: Company and Person add link to X25RefCompany, delete zombies</td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=2'>Resync EB</a></td>"
				    + "<td>Use this tool each time any DB changes are made: Add/Modify fields and types. It is safe to run this tool multiple times, however it runs a few minutes. Be Patient.</td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=3'>Fix Email</a></td>"
				    + "<td>Fixes emails after a Marketing YP/... has added new leads. Some emails are broken.  </td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=7'>Import Enterprise Companies (step #2)</a></td>"
				    + "<td>Check all Phone/Email/Web and pull over companies if not here yet. </td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=4'>Import EB Enterprise (step #1)</a></td>"
				    + "<td>You must make a backup first. This allows you to import full or partial data from another Enterprise DB.   </td></tr>"
				    + "<tr><td><a href='./?a="
				    + stA
				    + "&b=4'>Import EB Enterprise (step #1)</a></td>"
				    + "<td>You must make a backup first. This allows you to import full or partial data from another Enterprise DB.   </td></tr>"
				    + "<tr><td><a href='./?a=" + stA
				    + "&b=1008'>Process EPS 8</a></td>"
				    + "</table><br>&nbsp;<br>&nbsp;";
			...
			default:
				stReturn = stReturn
				    + "<BR>ERROR getDbManagement: invalid state/process: " + iState;
			}
		} catch (Exception e) {
	...
	public String getAdmin(ResultSet rsA, HttpServletRequest request) {
		...
		try {
			...
			case 1902:
				...
				break;
			default:
				stReturn = stReturn + "<br>ERROR: invalid admin "
				    + rsA.getInt("nmProcessId");
			}
		...
		try {
			...
			if (rsF != null) {
				...
				for (int iF = 1; iF <= iMaxF; iF++) {
					...
					eb = new EbDatabase(rsF.getInt("nmDbType"),
					    rsF.getString("stServerIp"), rsF.getString("stUser"),
					    rsF.getString("stPassword"), rsF.getString("stDbName"), "");
					...
					for (int iFld = 1; iFld <= iFieldMax; iFld++) {
						...
						int nmFieldId = this.ebEnt.dbEb
						    .ExecuteSql1n("select f.nmFieldId from t_tables t, t_fields f where t.nmTableId = f.nmTableId and t.nmDbId = "
						        + rsF.getInt("nmDbId")
						        + " and f.stDbFieldName = '"
						        + rsFields.getString("stDbFieldName") + "'");
						ResultSet rsF2 = this.ebEnt.dbEb
						    .ExecuteSql("select * from t_fields2 where nmFieldId="
						        + nmFieldId);
						int iCount = 0;
						if (rsF2 != null) {
							rsF2.last();
						...
						if (iCount > 0)
							continue;
						stSql = "insert into t_fields2 (nmFieldId,nmDataType,nmFlags,nmOrder2,nmGrouping,nmGroupingOrder,stDefaultValue,nmTabId,stTabName,stLabel,nmOrder,nmHeaderOrder,nmMinBytes,nmMaxBytes,nmRows,nmCols,nmSecurityFlags,nmReadFlags,nmWriteFlags,nmRecordFlags,nmFieldFlags,nmLookup,nmShowLookup,stReadUG,nmReportFlags,stAllowUG,stMask,stValidation,stValidParam,nmComparison,nmFieldCalc) values("
						    + nmFieldId
						    + ","
						    + rsFields.getString("nmDataType")
						    + ","
						    + rsFields.getString("nmFlags")
						    + ","
						    + rsFields.getString("nmOrder2")
						    + ","
						    + rsFields.getString("nmGrouping")
						    + ","
						    + rsFields.getString("nmGroupingOrder")
						    + ","
						    + this.ebEnt.dbEb.fmtDbString(rsFields
						        .getString("stDefaultValue"))
						    + ","
						    + rsFields.getString("nmTabId")
						    + ","
						    + this.ebEnt.dbEb.fmtDbString(rsFields.getString("stTabName"))
						    + ","
						    + this.ebEnt.dbEb.fmtDbString(rsFields.getString("stLabel"))
						    + ","
						    + rsFields.getString("nmOrder")
						    + ","
						    + rsFields.getString("nmHeaderOrder")
						    + ","
						    + rsFields.getString("nmMinBytes")
						    + ","
						    + rsFields.getString("nmMaxBytes")
						    + ","
						    + rsFields.getString("nmRows")
						    + ","
						    + rsFields.getString("nmCols")
						    + ","
						    + rsFields.getString("nmSecurityFlags")
						    + ","
						    + rsFields.getString("nmReadFlags")
						    + ","
						    + rsFields.getString("nmWriteFlags")
						    + ","
						    + rsFields.getString("nmRecordFlags")
						    + ","
						    + rsFields.getString("nmFieldFlags")
						    + ","
						    + rsFields.getString("nmLookup")
						    + ","
						    + rsFields.getString("nmShowLookup")
						    + ","
						    + this.ebEnt.dbEb.fmtDbString(rsFields.getString("stReadUG"))
						    + ","
						    + rsFields.getString("nmReportFlags")
						    + ","
						    + this.ebEnt.dbEb.fmtDbString(rsFields.getString("stAllowUG"))
						    + ","
						    + this.ebEnt.dbEb.fmtDbString(rsFields.getString("stMask"))
						    + ","
						    + this.ebEnt.dbEb.fmtDbString(rsFields
						        .getString("stValidation"))
						    + ","
						    + this.ebEnt.dbEb.fmtDbString(rsFields
						        .getString("stValidParam"))
						    + ","
						    + rsFields.getString("nmComparison")
						    + ","
						    + rsFields.getString("nmFieldCalc") + ")";
		...
		try {
			...
			if (rs != null) {
				...
				for (int iU = 1; iU <= iMaxRow; iU++) {
					...
					if (iFound <= 0)
						continue;
					this.ebEnt.dbEnterprise.ExecuteUpdate("update X25User set stEMail="
					    + this.ebEnt.dbEnterprise.fmtDbString(stEmail) + " where RecId="
					    + rs.getString("RecId"));
				}
			}
		} catch (Exception e) {
	...
	public String getResetEb() {
		...
		try {
			...
			this.ebEnt.dbEb
			    .ExecuteUpdate("update t_databases set nmDbFlag = ( nmDbFlag | 0x40000000)");
			this.ebEnt.dbEb
			    .ExecuteUpdate("update t_tables set nmTableFlag = ( nmTableFlag |  0x40000000)");
			this.ebEnt.dbEb
			    .ExecuteUpdate("update t_fields set nmFieldFlag = ( nmFieldFlag & ~0x00F00000)");
			this.ebEnt.dbEb
			    .ExecuteUpdate("update t_fields set nmFieldFlag = ( nmFieldFlag |  0x40000000)");
			...
			for (int iRS = 1; iRS <= iMaxServer; iRS++) {
				rsS.absolute(iRS);
				eb = new EbDatabase(rsS.getInt("nmDbType"),
				    rsS.getString("stServerIp"), rsS.getString("stUser"),
				    rsS.getString("stPassword"), "", "");
				...
				for (int iRD = 1; iRD <= iMaxDatabases; iRD++) {
					...
					case 0:
						...
						if ((!stDbName.equals("mysql"))
						    && (!stDbName.equals("information_schema")))
							break;
						iSkip = 1;
						break;
					case 1:
						stDbName = rsD.getString("DATABASE_NAME");
						if ((!stDbName.equals("model")) && (!stDbName.equals("master"))
						    && (!stDbName.equals("msdb")) && (!stDbName.equals("pubs"))
						    && (!stDbName.equals("tempdb")))
							break;
						iSkip = 1;
					}
					...
					int iDbId = this.ebEnt.dbEb
					    .ExecuteSql1n("select nmDbId from t_databases where nmServerId="
					        + rsS.getInt("nmServerId") + " and stDbName='" + stDbName
					        + "'");
					if (iDbId <= 0) {
						iDbId = this.ebEnt.dbEb
						    .ExecuteSql1n("select max(nmDbId) from t_databases ");
						iDbId++;
						this.ebEnt.dbEb
						    .ExecuteUpdate("insert into t_databases (nmDbId,nmServerId,stDbName) values("
						        + iDbId
						        + ", "
						        + rsS.getInt("nmServerId")
						        + ",'"
						        + stDbName
						        + "') ");
					}
					this.ebEnt.dbEb
					    .ExecuteUpdate("update t_databases set nmDbFlag = ( nmDbFlag & ~0x40000000) where nmDbId="
					        + iDbId);

					EbDatabase ebD = new EbDatabase(rsS.getInt("nmDbType"),
					    rsS.getString("stServerIp"), rsS.getString("stUser"),
					    rsS.getString("stPassword"), stDbName, "");
					switch (rsS.getInt("nmDbType")) {
					case 0:
					...
					case 1:
						rsT = ebD
						    .ExecuteSql("SELECT * FROM INFORMATION_SCHEMA.TABLES AS data WHERE TABLE_TYPE = 'BASE TABLE'");
					}
					...
					for (int iRT = 1; iRT <= iMaxTables; iRT++) {
						...
						int iTableId = this.ebEnt.dbEb
						    .ExecuteSql1n("select nmTableId from t_tables where nmDbId="
						        + iDbId + " and stTableName='" + stTableName + "'");
						if (iTableId <= 0) {
							iTableId = this.ebEnt.dbEb
							    .ExecuteSql1n("select max(nmTableId) from t_tables");
							iTableId++;
							this.ebEnt.dbEb
							    .ExecuteUpdate("insert into t_tables (nmTableId,nmDbId,stTableName,stDbEngine,dtLastCheck) values("
							        + iTableId
							        + ","
							        + iDbId
							        + ",'"
						...
						this.ebEnt.dbEb
						    .ExecuteUpdate("update t_tables set dtLastCheck=now(), nmTableFlag = ( nmTableFlag & ~0x40000000)  where nmTableId="
						        + iTableId);
						...
						for (int iRF = 1; iRF <= iMaxFields; iRF++) {
							...
							case 1:
								...
								aF = parseFieldType(stFieldType);
								if ((!stFieldType.equals("char"))
								    && (!stFieldType.equals("varchar")))
									break;
								aF[1] = rsF.getInt("LENGTH");
							}

							int iFieldId = this.ebEnt.dbEb
							    .ExecuteSql1n("select nmFieldId from t_fields where nmTableId="
							        + iTableId + " and stDbFieldName='" + stDbFieldName + "'");
							if (iFieldId <= 0) {
								iFieldId = this.ebEnt.dbEb
								    .ExecuteSql1n("select max(nmFieldId) from t_fields ");
								iFieldId++;
								this.ebEnt.dbEb
								    .ExecuteUpdate("insert into t_fields(nmFieldId,nmTableId,stDbFieldName) values("
								        + iFieldId
								        + ","
								        + iTableId
								        + ",'"
							...
							this.ebEnt.dbEb.ExecuteUpdate("update t_fields set stFieldType='"
							    + stFieldType + "',stDefault='" + stDefault + "',stExtra='"
							    + stExtra + "',nmFieldType=" + aF[0] + ",nmFieldSize="
							    + aF[1] + ",nmTableOrder=" + iRF
							    + ",nmFieldFlag = ( (nmFieldFlag |" + nmFieldFlag
							    + " )& ~0x40000000) where nmFieldId=" + iFieldId);
						}
					}
					ebD.ebClose();
			...
			this.ebEnt.dbEb
			    .ExecuteUpdate("delete from t_databases where ( nmDbFlag & 0x40000000) != 0 ");
			this.ebEnt.dbEb
			    .ExecuteUpdate("delete from t_tables where ( nmTableFlag & 0x40000000) != 0 ");
			this.ebEnt.dbEb
			    .ExecuteUpdate("delete from t_fields where ( nmFieldFlag & 0x40000000) != 0 ");
			...
			if (rsS1 != null) {
				...
				for (int iS = 1; iS <= iMaxS1; iS++) {
					rsS1.absolute(iS);
					stDbName = this.ebEnt.dbEb
					    .ExecuteSql1("SELECT max(stDbName) FROM t_databases where nmServerId="
					        + rsS1.getInt("nmServerId"));
					if ((stDbName == null) || (stDbName.equals("")))
						continue;
					EbDatabase ebTemp = new EbDatabase(rsS1.getInt("nmDbType"),
					    rsS1.getString("stServerIp"), rsS1.getString("stUser"),
					    rsS1.getString("stPassword"), stDbName, "");
					...
					for (int iR = 1; iR <= iMax; iR++) {
						rsPk.absolute(iR);
						int nmFieldId = this.ebEnt.dbEb
						    .ExecuteSql1n("SELECT f.nmFieldId FROM t_fields f, t_tables t, t_databases d, t_server s where s.nmDbType=1 and s.nmServerId=d.nmServerId and d.nmDbId=t.nmDbId and t.nmTableId=f.nmTableId and d.stDbName='"
						        + rsPk.getString("TABLE_CATALOG")
						        + "' and t.stTableName='"
						        + rsPk.getString("TABLE_NAME")
						        + "' and f.stDbFieldName='"
						        + rsPk.getString("COLUMN_NAME") + "'");
						this.ebEnt.dbEb
						    .ExecuteUpdate("update t_fields set nmFieldFlag = ( nmFieldFlag | 0x00800000) where nmFieldId="
						        + nmFieldId);
					}
			...
			for (int iR = 1; iR <= iMaxRow; iR++) {
				...
				if ((iTableId != iLastTable) && (iLastTable > 0)) {
					this.ebEnt.dbEb.ExecuteUpdate("update t_tables set stPk='" + stPk
					    + "', stPkFids='" + stPkFids + "' where nmTableId=" + iLastTable);
					stPk = stPkFids = "";
				}
				if (!stPk.equals("")) {
					stPk = stPk + "|";
	...
	public String fixCrossLinksZombies(ResultSet rsA, HttpServletRequest request) {
		...
		try {
			stReturn = stReturn
			    + addCompanyLinks("SELECT DISTINCT ru1.nmPersonId as nmPersonId, ru2.nmPersonId as nmCompanyId  FROM X25RefUser ru1 left join X25RefCompany rc on rc.nmRefType=1 and rc.nmRefId=ru1.nmPersonId, X25RefUser ru2 where ru1.nmRefType=1 and ru1.nmUserId=ru2.nmUserId and ru2.nmRefType=2 and rc.nmCompanyId is null");

			stReturn = stReturn
			    + addCompanyLinks("SELECT DISTINCT rp1.nmRefId as nmPersonId, rp2.nmRefId as nmCompanyId FROM X25RefPhone rp1 left join X25RefCompany rc on rc.nmRefType=1 and rc.nmRefId=rp1.nmRefId,X25RefPhone rp2 where rp1.nmRefType=1 and rp1.nmPhoneId=rp2.nmPhoneId and rp2.nmRefType=2 and rc.nmCompanyId is null");
	...
	public String fixCommHistory() {
		...
		try {
			...
			for (int iC = 1; iC <= iMax; iC++) {
				...
				ResultSet rs2 = this.ebEnt.dbEnterprise
				    .ExecuteSql("select RecId from X25Communications where stForeignRefId = "
				        + this.ebEnt.dbEnterprise.fmtDbString(rs
				            .getString("stForeignRefId")) + " order by RecId ");
				...
				for (int iDel = 2; iDel <= iMax2; iDel++) {
					rs2.absolute(iDel);
					this.ebEnt.dbEnterprise
					    .ExecuteUpdate("delete from X25Communications where RecId="
					        + rs2.getString("RecId"));
				}
			}
			...
			for (int iC2 = 1; iC2 <= iMax2; iC2++) {
				...
				int i = this.ebEnt.ebNorm.getPersonId(aName[0], "", "", 0,
				    rs2.getInt("nmUserId"));
				stReturn = stReturn + " added i " + i;
			}
			stReturn = stReturn + "<br> " + iMax2
			    + " b) add preson to new email addresses ";
			...
			for (int iC3 = 1; iC3 <= iMax3; iC3++) {
				...
				this.ebEnt.dbEnterprise
				    .ExecuteUpdate("update X25Communications set nmPersonId="
				        + rs3.getString("nmPersonId") + " where RecId="
				        + rs3.getString("RecId"));
			}
			stReturn = stReturn + "<br> " + iMax3
			    + " b) set person id in COMM PART 2";
			...
			for (int iC4 = 1; iC4 <= iMax4; iC4++) {
				rs4.absolute(iC4);
				this.ebEnt.dbEnterprise
				    .ExecuteUpdate("insert into X25HistoryLog (nmUserId,nmRefType,nmRefId,dtEventStartTime,dtEventEndTime,nmRefType2,nmRefId2,stComment,nmEventFlags) values("
				        + this.ebEnt.ebUd.getLoginId()
				        + ",1,"
				        + rs4.getString("nmPersonId")
				        + ",'"
			...
			for (int iC5 = 1; iC5 <= iMax5; iC5++) {
				rs5.absolute(iC5);
				this.ebEnt.ebNorm.mergePerson(rs5.getString("stFirstName"),
				    rs5.getString("stMiddleName"), rs5.getString("stLastName"));
			}
			stReturn = stReturn + "<br> " + iMax5
			    + " d) temporary ... fix multi entries created from import ";
		} catch (Exception e) {
		...
		try {
			...
			if (iSubState > 1) {
				...
				if ((stDbName != null) && (stDbName.length() > 0)) {
					...
					stReturn = stReturn
					    + "<br><font color=red>ERROR: cannot leave dbname blank</font><br>";
				}
				if (db == null) {
					iSubState = 1;
				}
			...
			case 1:
				stReturn = stReturn
				    + "</form><form method=post><input type=hidden name=a value='"
				    ...
				    + "<table>"
				    + "<tr><td>DB Name(must be on same server as 'ederbase'):</td><td>"
				    + "<input type=text name=dbname value=''></td></tr>"
				    + "<tr><th colspan=2><input type=submit name=submit value='Import Now'</td></tr>"
				    + "</table></form><br><font color=red>NOTE: it will store each person with phone/email in new row !!! need to fix it.</font>";

				break;
			case 2:
				stReturn = stReturn
				    + "<table><tr><th colspan=2>Importing Companies from " + stDbName
				    + "</th></tr>";
				ResultSet rs = this.ebEnt.dbEnterprise
				    .ExecuteSql("SELECT DISTINCT ru.nmPersonId,u.stEMail FROM X25RefUser ru left join X25RefCompany rc on rc.nmRefType=1 and rc.nmRefId=ru.nmPersonId, X25User u where ru.nmRefType=1 and u.RecId=ru.nmUserId and rc.nmRefId is null");

				if (rs != null) {
					rs.last();
					int iMax = rs.getRow();
					stReturn = stReturn + "<tr><td>By Email reference: </td><td>" + iMax
					    + "</td>";
					for (int iT = 1; iT <= iMax; iT++) {
						...
						stSql = "select distinct mu.stEMail,mc.*,ma.*,mz.*,mw.* from X25Company mc left join X25WebSite mw on mw.nmCompanyId=mc.RecId, X25RefAddress mra, X25Address ma, X25Zip mz,X25RefCompany mrcc, X25RefUser mru, X25User mu where mc.RecId=mra.nmRefId and mra.nmRefType=2 and ma.RecId=mra.nmAddressId and mz.RecId=ma.nmZipId and mrcc.nmRefType=1 and mrcc.nmCompanyId=mc.RecId and mrcc.nmRefId = mru.nmPersonId and mru.nmRefType=1 and mru.nmUserId=mu.RecId and mu.stEMail = "
						    + db.fmtDbString(rs.getString("stEMail"));
						...
						for (int iI = 1; iI <= iMaxI; iI++) {
							...
							int nmAddressId = this.ebEnt.ebNorm.getAddressId(
							    rsImport.getString("stAddress1"),
							    rsImport.getString("stAddress2"),
							    rsImport.getString("stZipCode"),
							    rsImport.getString("stCity"),
							    rsImport.getString("stStateShort"),
							    rsImport.getString("stCountry"));

							int nmEmailId = 0;
							int nmPhoneId = 0;
							int nmWebId = this.ebEnt.ebNorm.getWebId(rsImport
							    .getString("stUrl"));
							int nmCompanyId = this.ebEnt.ebNorm.getCompanyId(
							    rsImport.getString("stCompanyName"), nmAddressId, nmPhoneId,
							    nmEmailId, nmWebId);

							this.ebEnt.ebNorm.addCompanyRef(nmCompanyId, 1,
							    rs.getInt("nmPersonId"));
						}
						rsImport.close();
					}
				...
				rs = this.ebEnt.dbEnterprise
				    .ExecuteSql("SELECT DISTINCT rp.nmRefId as nmPersonId,p.stPhone FROM X25RefPhone rp left join X25RefCompany rc on rc.nmRefType=1 and rc.nmRefId=rp.nmRefId, X25Phone p where rp.nmRefType=1 and p.RecId=rp.nmPhoneId and rc.nmRefId is null");

				if (rs != null) {
					rs.last();
					int iMax = rs.getRow();
					stReturn = stReturn + "<tr><td>By Phone reference: </td><td>" + iMax
					    + "</td>";
					for (int iT = 1; iT <= iMax; iT++) {
						rs.absolute(iT);
						stSql = "select distinct mp.stPhone,mc.*,ma.*,mz.*,mw.* from X25Company mc left join X25WebSite mw on mw.nmCompanyId=mc.RecId, X25RefAddress mra, X25Address ma, X25Zip mz,X25RefCompany mrcc, X25RefPhone mrp, X25Phone mp where mc.RecId=mra.nmRefId and mra.nmRefType=2 and ma.RecId=mra.nmAddressId and mz.RecId=ma.nmZipId and mrcc.nmRefType=1 and mrcc.nmCompanyId=mc.RecId and mrcc.nmRefId = mrp.nmRefId and mrp.nmRefType=1 and mrp.nmPhoneId=mp.RecId and mp.stPhone = "
						    + db.fmtDbString(rs.getString("stPhone"));
			...
			default:
				stReturn = stReturn
				    + "<BR>ERROR getImportCompanies: invalid sub-state/sub=process: "
				    + iSubState;
			}
		} catch (Exception e) {
		...
		try {
			...
			case 1:
				stReturn = stReturn
				    ...
				    + "<tr><td>DB Name(must be on same server as 'ederbase'):</td><td>"
				    + "<input type=text name=dbname value=''></td></tr>"
				    + "<tr><td>Query:</td><td><textarea name=sql rows=10 cols=100>"
				    + "select p.stLastName, p.stFirstName, p.stMiddleName,ph.stPhone,u.stEMail, h.*"
				    ...
				    + "\n order by p.stLastName, p.stFirstName, h.RecId</textarea></td></tr>"
				    + "<tr><th colspan=2><input type=submit name=submit value='Import Now'</td></tr>"
				    + "</table></form><br><font color=red>NOTE: it will store each person with phone/email in new row !!! need to fix it.</font>";
			...
			case 2:
				...
				ResultSet rsImport = db.ExecuteSql(stSql);
				stReturn = stReturn + "<table><tr><th colspan=2>Importing from "
				    + stDbName + "</th></tr>";
				if (rsImport != null) {
					rsImport.last();
					...
					for (int iI = 1; iI <= iMax; iI++) {
						...
						nmPersonId = this.ebEnt.ebNorm.getPersonId(stFirstName,
						    stMiddleName, stLastName, stPhone, "US", stEMail);

						if (stLast.equals(rsImport.getString("RecId"))) {
							stBg = " bgcolor=pink ";
						} else {
							this.ebEnt.ebNorm.addHistory(1, nmPersonId,
							    rsImport.getString("dtEventStartTime"),
							    rsImport.getString("stComment"), 0, 0);
							stBg = " bgcolor=lightgreen ";
						}

						stReturn = stReturn + "<tr><td align=right>" + nmPersonId + "</td>"
						    + "<td>" + stFirstName + "</td>" + "<td>" + stLastName
						    + "</td>" + "<td>" + stPhone + "</td>" + "<td>" + stEMail
						    + "</td>" + "<td " + stBg + ">" + rsImport.getString("RecId")
						    + "</td>" + "<td>" + rsImport.getString("dtEventStartTime")
						    + "</td>" + "<td>" + rsImport.getString("stComment") + "</td>"
						    + "</tr>";
			...
			default:
				stReturn = stReturn
				    + "<BR>ERROR getImportEnterprise: invalid sub-state/sub=process: "
				    + iSubState;
			}
		} catch (Exception e) {
		...
		try {
			if (stTb != null) {
				...
				if (aV[1].equals("d"))
					...
					stDb = aV[1];
				stTn = this.ebEnt.dbEb
				    .ExecuteSql1("select t.nmTableId from t_tables t, t_databases d where t.nmDbId=d.nmDbId and d.nmServerId="
				        + aV[0]
				        + " and d.stDbName=\""
				        + stDb
				        + "\" and t.stTableName = \"" + aV[2] + "\"");
			}
		} catch (Exception e) {
	...
	public String getTableEdit(HttpServletRequest request) {
		...
		try {
			...
			if ((stTn == null) || (stTn.equals(""))) {
				...
				iRowMax = rs.getRow();
				stReturn = stReturn
				    + "<form method=post><table border=1><tr><th colspan=5>Table Editor</th></tr>";
				for (iF = 1; iF <= iRowMax; iF++) {
					rs.absolute(iF);
					stReturn = stReturn + "<tr>";
					stReturn = stReturn + "<td align=right>" + rs.getString("nmRows")
					    + "</td>";
					stReturn = stReturn + "<td><a href='./?a=28&tn="
					    + rs.getString("nmTableId") + "'><b>"
					    + rs.getString("stTableName") + "</b></a></td>";
				...
				stSql = "SELECT s.*,t.stTableName,d.stDbName,t.stPk,t.stPkFids FROM t_tables t, t_databases d, t_server s where s.nmServerId = d.nmServerId and d.nmDbId = t.nmDbId and t.nmTableId="
				    + stTn;

				ResultSet rsDb = this.ebEnt.dbEb.ExecuteSql(stSql);
				rsDb.absolute(1);
				dbTemp = new EbDatabase(rsDb.getInt("nmDbType"),
				    rsDb.getString("stServerIp"), rsDb.getString("stUser"),
				    rsDb.getString("stPassword"), rsDb.getString("stDbName"),
				    rsDb.getString("stConnectString"));
				String stSqlList = "";
				if (rsDb.getInt("nmDbType") == 1) {
					stSqlList = "select top 1000 * from " + rsDb.getString("stTableName");
				} else {
					stSqlList = "select * from " + rsDb.getString("stTableName")
					    + " limit 1000 ";
				}
				ResultSet rsF = this.ebEnt.dbEb
				    .ExecuteSql("select * from t_fields where nmTableId=" + stTn
				        + " order by stDbFieldName");
				rsF.last();
				...
				for (; iF <= iFieldMax; iF++) {
					rsF.absolute(iF);
					stReturn1 = stReturn1 + "<th>" + rsF.getString("stDbFieldName")
					    + "</th>";
				...
				if ((stTid != null) && (!stTid.equals(""))) {
					...
					if ((stTemp != null) && (stTemp.equals("y"))) {
						stSql = "delete from " + rsDb.getString("stTableName") + " where "
						    + stPk;
						...
						String stUpdate = "";
						if ((stTemp != null)
						    && ((stTemp.equals("Save data")) || (stTemp
						        .equals("Insert as new")))) {
							if (((aPkValue[0].length() >= 2) && (aPkValue[0].substring(0, 2)
							    .equals("-2"))) || (stTemp.equals("Insert as new"))) {
								String s1 = "";
								String s2 = "";
								...
								for (; iF <= iFieldMax; iF++) {
									rsF.absolute(iF);
									stTemp = request.getParameter("g" + rsF.getInt("nmFieldId")
									    + "|" + stTid);
								...
								stSql = "insert into " + rsDb.getString("stTableName") + " ("
								    + s1 + ") values(" + s2 + ")";
								dbTemp.ExecuteUpdate(stSql);
							} else {
								stSql = "select * from " + rsDb.getString("stTableName")
								    + " where " + stPk;
								...
								if (!stUpdate.equals("")) {
									dbTemp.ExecuteUpdate("update "
									    + rsDb.getString("stTableName") + " set " + stUpdate
									    + " where " + stPk);
								}
							}
				...
				if ((stTid == null) || (stTid.trim().equals(""))) {
					stReturn = stReturn
					    + "<form method=post><table border=1><tr><th colspan="
					    + (iFieldMax + 1)
					    + ">Table: "
					    + rsDb.getString("nmServerId")
					    + "."
					    + rsDb.getString("stDbName")
					    + "."
					    + rsDb.getString("stTableName")
					    + " ["
					    + iRowMax
					    + " rows] <a href='./?a=28&tn="
					    + stTn
					    + "&tid=-2' title='Insert'><img border=0 src='./common/b_insrow.png'> Insert</a></th></tr><tr>";
					...
					for (iD = 1; iD <= iRowMax; iD++) {
						...
						if (!stPkValue.equals("")) {
							stReturn = stReturn
							    + "<td valign=top><a title='Edit' href='./?a=28&tn="
							    + stTn
							    + "&tid="
							    + stPkValue
							    + "'><img border=0 src='./common/b_edit.png'></a> <a title='Delete' href='./?a=28&tn="
							    + stTn
							    + "&tid="
							    + stPkValue
							    + "&del=y' onclick=\"return confirm('Are you sure you want to delete?')\"><img border=0 src='./common/b_drop.png'></a></td>";
						} else {
					...
					stSql = "select * from " + rsDb.getString("stTableName") + " where "
					    + stPk;
					...
					stReturn = stReturn
					    + "\n<form method=post><table border=0><tr><th colspan=2 bgcolor='skyblue'>Edit Table: "
					    + rsDb.getString("nmServerId") + "." + rsDb.getString("stDbName")
					    + "." + rsDb.getString("stTableName") + "</th></tr><tr>";
					...
					for (iD = 1; iD <= iRowMax; iD++) {
						...
						for (iF = 1; iF <= iFieldMax; iF++) {
							...
							stReturn = stReturn + "<td align=right valign=top " + stBg + ">"
							    + rsF.getString("stDbFieldName") + "</th>";
			...
			this.stError = (this.stError + "ERROR getTableEdit( " + stTn + " ,  "
			    + stTid + ") iD " + iD + " iF " + iF + " stValue [" + stValue + "]: " + e);
			if (dbTemp != null) {
				this.stError += dbTemp.getError();
				dbTemp.ebClose();
			}
	...
	int[] parseFieldType(String stFieldType) {
		...
		if (stTemp.equals("bigint")) {
			aF[0] = 35;
		} else if ((stTemp.equals("year")) || (stTemp.equals("bit"))
		    || (stTemp.equals("byte")) || (stTemp.equals("tinyint"))
		    || (stTemp.equals("counter")) || (stTemp.equals("enum"))
		    || (stTemp.equals("int")) || (stTemp.equals("integer"))
		    || (stTemp.equals("mediumint")) || (stTemp.equals("smallint"))
		    || (stTemp.equals("timestamp"))) {
			aF[0] = 10;
		...
		} else if ((stTemp.equals("char")) || (stTemp.equals("sysname"))
		    || (stTemp.equals("varchar"))) {
			aF[0] = 3;
		} else if ((stTemp.equals("set")) || (stTemp.equals("image"))
		    || (stTemp.equals("blob")) || (stTemp.equals("longblob"))
		    || (stTemp.equals("longtext")) || (stTemp.equals("longchar"))
		    || (stTemp.equals("mediumblob")) || (stTemp.equals("mediumtext"))
		    || (stTemp.equals("nchar")) || (stTemp.equals("ntext"))
		    || (stTemp.equals("text")) || (stTemp.equals("tinyblob"))) {
			aF[0] = 4;
		} else if ((stTemp.equals("float")) || (stTemp.equals("decimal"))
		    || (stTemp.equals("double")) || (stTemp.equals("money"))
		    || (stTemp.equals("real"))) {
			aF[0] = 31;
	...
	public String fixMailQ() {
		...
		if ((stValue != null) && (stValue.length() > 0)) {
			...
			int iL = 0;
			for (int iFound = 0; iL < aLines.length; iL++) {
				...
				if (iFound > 0) {
					...
					stReturn = stReturn + "<br>Removing: " + stLine + " nmErrorCount: "
					    + nmErrorCount;
					iFound = 0;
			...
			stReturn = stReturn
			    + "</form><form method=post><br>Copy mailq output here<br><textarea name='stMailQ' cols=150 rows=20></textarea></br><input type=submit name=sumbit8 value='Process mailq'></form>";
		}
	...
	public String processHourly(int iInterval) {
		...
		try {
			if (iInterval > 0) {
				stSql = "SELECT count(*) as cnt, year(dtEntered)as y,month(dtEntered) as m, day(dtEntered) as d, hour(dtEntered) as h FROM X25Counter where dtEntered >= DATE_ADD(now(),INTERVAL -"
				    + iInterval
				    + " HOUR) "
				    + "group by year(dtEntered), month(dtEntered) ,day(dtEntered) ,hour(dtEntered) "
				    + "order by year(dtEntered) desc,month(dtEntered) desc,day(dtEntered) desc,hour(dtEntered) desc";
			} else {
			...
			if (rs != null) {
				...
				for (int iH = 1; iH <= iMax; iH++) {
					rs.absolute(iH);
					stSql = "replace into MyHourlyTable (nmClicks,nmYear,nmMonth,nmDay,nmHour) values("
					    + rs.getString(1)
					    + ","
					    + rs.getString(2)
					    + ","
	...
	public String processHourlyMood(int iInterval) {
		...
		try {
			if (iInterval > 0) {
				stSql = "SELECT count(*) as cnt, year(dtReported)as y,month(dtReported) as m, day(dtReported) as d, hour(dtReported) as h,sum(nmMood) as mood  FROM MyMoodReport where dtReported >= DATE_ADD(now(),INTERVAL -"
				    + iInterval
				    + " HOUR) "
				    + "group by year(dtReported), month(dtReported) ,day(dtReported) ,hour(dtReported) "
				    + "order by year(dtReported) desc,month(dtReported) desc,day(dtReported) desc,hour(dtReported) desc";
			} else {
			...
			if (rs != null) {
				...
				for (int iH = 1; iH <= iMax; iH++) {
					...
					int i = this.ebEnt.dbEnterprise
					    .ExecuteSql1n("select count(*) from MyHourlyTable where nmYear="
					        + rs.getString(2) + " and nmMonth=" + rs.getString(3)
					        + " and " + "nmDay=" + rs.getString(4) + " and nmHour="
					        + rs.getString(5));

					if (i <= 0) {
						stSql = "insert into MyHourlyTable (nmMoodCount,nmYear,nmMonth,nmDay,nmHour,nmMoodSum) values("
						    + rs.getString(1)
						    + ","
						    + rs.getString(2)
						    + ","
						...
						stSql = "update MyHourlyTable set nmMoodCount=" + rs.getString(1)
						    + ",nmMoodSum=" + rs.getString(6) + " where nmYear="
						    + rs.getString(2) + " and nmMonth=" + rs.getString(3) + " and "
						    + "nmDay=" + rs.getString(4) + " and nmHour=" + rs.getString(5);
					}
	...
	public String processHourlyPets(int iInterval) {
		...
		try {
			if (iInterval > 0) {
				stSql = "SELECT count(*) as cnt, year(dtReported)as y,month(dtReported) as m, day(dtReported) as d, hour(dtReported) as h,sum(nmPetMood) as mood  FROM MyPetReport where dtReported >= DATE_ADD(now(),INTERVAL -"
				    + iInterval
				    + " HOUR) "
				    + "group by year(dtReported), month(dtReported) ,day(dtReported) ,hour(dtReported) "
				    + "order by year(dtReported) desc,month(dtReported) desc,day(dtReported) desc,hour(dtReported) desc";
			...
			if (rs != null) {
				...
				for (int iH = 1; iH <= iMax; iH++) {
					rs.absolute(iH);
					String stDetail = "";
					String stDate = rs.getString(2) + "-" + rs.getString(3) + "-"
					    + rs.getString(4) + " " + rs.getString(5);
					stSql = "SELECT count(*) as cnt, year(dtReported)as y,month(dtReported) as m, day(dtReported) as d, hour(dtReported) as h,sum(nmPetMood)/ count(*) as avg, stCountry,stState,stCity,stIp FROM MyPetReport where dtReported >='"
					    + stDate
					    + ":00:00' and dtReported <='"
					    + stDate
					    + ":59:59' "
					    + "group by stIp, year(dtReported), month(dtReported) ,day(dtReported) ,hour(dtReported),stCountry,stState,stCity  "
					    + "order by stIP, year(dtReported) desc,month(dtReported) desc,day(dtReported) desc,hour(dtReported) desc,stCountry,stState,stCity";
					...
					if (rs1 != null) {
						...
						for (int iM = 1; iM <= iMx; iM++) {
							...
							stDetail = stDetail + "<td class='FormField'>"
							    + rs1.getString("stCountry") + "</td>";
							stDetail = stDetail + "<td class='FormField'>"
							    + rs1.getString("stState") + "</td>";
							stDetail = stDetail + "<td class='FormField'>"
							    + rs1.getString("stCity") + "</td>";
							stDetail = stDetail + "<td class='FormField'>"
							    + rs1.getString("cnt") + "</td>";
							stDetail = stDetail + "<td class='FormField'><b>"
							    + rs1.getString("avg") + "</b></td>";
							stDetail = stDetail + "<td class='FormField'>"
							    + rs1.getString("stIp") + "</td>";
							stDetail = stDetail + "</tr>";
						}
					...
					if (i <= 0) {
						stSql = "insert into MyHourlyTable (nmPetCount,nmYear,nmMonth,nmDay,nmHour,nmPetSum,stPetDetail) values("
						    + rs.getString(1)
						    + ","
						    + rs.getString(2)
						    + ","
						    ...
						    + rs.getString(6)
						    + ","
						    + this.ebEnt.dbEnterprise.fmtDbString(stDetail) + ")";
					} else {
						stSql = "update MyHourlyTable set nmPetCount=" + rs.getString(1)
						    + ",nmPetSum=" + rs.getString(6) + "," + "stPetDetail = "
						    + this.ebEnt.dbEnterprise.fmtDbString(stDetail)
						    + " where nmYear=" + rs.getString(2) + " and nmMonth="
						    + rs.getString(3) + " and " + "nmDay=" + rs.getString(4)
						    + " and nmHour=" + rs.getString(5);
					}

					this.ebEnt.dbEnterprise.ExecuteUpdate(stSql);
					stReturn = stReturn + "<BR>" + iH + ": " + rs.getString(5)
					    + " Pet Count: " + rs.getString(1);
				}
	...
	public String processTwitter(HttpServletRequest request) {
		...
		if ((stValue != null) && (stValue.length() > 0)) {
			...
			stReturn = stReturn
			    + "</form><form method=post><br>Twitter commands<br>L0: user  L1 # rpp L2: # of searches L3: search<br><textarea name='stInsert' cols=150 rows=20>mypetalert\n1\n1\npet\n</textarea><br><input type=submit name=sumbit8 value='Twitter'></form>";
		}
	...
	public String processSearchFollowers() {
		...
		if ((stValue != null) && (stValue.length() > 0)) {
			...
			stReturn = stReturn
			    + ebTwitter.processSearchFollowers(aCmd[0].trim(),
			        Integer.parseInt(aCmd[1].trim()),
			        Integer.parseInt(aCmd[2].trim()));

			this.stError += ebTwitter.getError();
		} else {
			stReturn = stReturn
			    + "</form><form method=post><br>processSearchFollowers<br>L0: user  L1 # iMaxSearchUsers L2: # of iMaxFolling <br><textarea name='stInsert' cols=150 rows=20>mypetalert\n1\n1\n</textarea><br><input type=submit name=sumbit8 value='Twitter'></form>";
		}
		...
		try {
			...
			if ((astResult != null) && (astResult.length > 0)) {
				for (int iR = 0; iR < astResult.length; iR++) {
					this.ebEnt.dbEnterprise
					    .ExecuteUpdate("update X25Communications com set nmFlags = 0x1000 where com.nmRefType=42 and ( stContent like '%http://www.spamarrest.com/%' or stContent like '%https://webmail.pas.earthlink.net/wam/addme?%' )and (nmFlags & 0x00000200) != 0 and com.nmRefId="
					        + astResult[iR]);
				}
				...
				stReturn = stReturn
				    + listConfirm("https://webmail.pas.earthlink.net/wam/addme?");

				stReturn = stReturn
				    + "<tr><td colspan=4 align=center><input type=submit name=submit9 value='Save Marked Users'></td></tr>";
			}
		} catch (Exception e) {
	...
	public String listConfirm(String stSearch) {
		...
		String stReturn = "";
		try {
			stSql = "SELECT u.stEMail, com.* FROM X25Communications com, X25User u where com.nmRefType=42 and com.nmRefId=u.RecId and stContent like '%"
			    + stSearch
			    + "%'"
			    + "and (nmFlags & 0x00000200) != 0 order by stEMail, com.RecId desc";
			...
			if (rs != null) {
				...
				for (int iC = 1; iC <= iMax; iC++) {
					...
					if (!stLast.equals(stEmail)) {
						...
						stReturn = stReturn + "<td><input type=checkbox name=usrs value='"
						    + rs.getString("nmRefId") + "'></td>";
						stUrl = "";
						...
						stReturn = stReturn + "<td><a href=\"" + stUrl
		...
		try {
			...
			if (rs != null) {
				...
				for (int iR = 1; iR <= iMax; iR++) {
					rs.absolute(iR);
					stReturn = stReturn
					    + markEmail(rs.getString("stContent"), rs.getInt("RecId"));
				}
				rs.close();
			}
			...
			this.stError = (this.stError + "<BR>ERROR fixUndeliverable: [" + stSql
			    + "] " + e);
		}
		return stReturn;
	}
	...
	public String markEmail(String stContent, int iRecId) {
		...
		if (stContent != null) {
			...
			for (int iL = 0; iL < aLines.length; iL++) {
				...
				this.ebEnt.dbEnterprise
				    .ExecuteUpdate("update X25Communications set nmFlags=0x100 where RecId="
				        + iRecId);
			}
			...
			if (iCount == 0) {
				...
				if (iCount == 0) {
					...
					stReturn = stReturn + "<br>ERROR: Cannot find email for com.RecId="
					    + iRecId + " content: " + stContent.replace("<", "&lt;");
					this.ebEnt.dbEnterprise
					    .ExecuteUpdate("update X25Communications set nmFlags=0x100 where RecId="
					        + iRecId);
				}
	...
	public int incEmailError(String stEmail) {
		...
		if (EbStatic.isEmail(stEmail) == true) {
			...
			if (nmUserId > 0) {
				this.ebEnt.dbEnterprise
				    .ExecuteUpdate("update X25User set nmErrorCount=(nmErrorCount+1) where RecId="
				        + nmUserId);
				nmErrorCount = this.ebEnt.dbEnterprise
				    .ExecuteSql1n("select nmErrorCount from X25User where RecId="
				        + nmUserId);

				if (nmErrorCount > 3) {
					this.ebEnt.dbEnterprise
					    .ExecuteUpdate("insert into X25DoNotCall (stValue,nmFlags,dtEntered) values("
					        + this.ebEnt.dbEnterprise.fmtDbString(stEmail) + ",2,now())");
				}
			}
	...
	public String processFiles() {
		...
		try {
			...
			if (rs != null) {
				...
				if ((stValue != null) && (stValue.length() > 0)) {
					stReturn = stReturn
					    + "<tr><th colspan=2><h1>Processing Send Twitter</h1></th></tr>";
					int iT = 1;
					for (; iT <= iMax; iT++) {
						rs.absolute(iT);
						...
						if ((stMessage == null) || (stMessage.length() <= 0))
							continue;
						stReturn = stReturn + "<tr>";
						stReturn = stReturn + "<td>" + rs.getString("stTwitterId")
						    + "</td>";
				...
				stReturn = stReturn
				    + "<tr><th colspan=2><h1>Send Twitter</h1></th></tr>";
				int iT = 1;
				for (; iT <= iMax; iT++) {
					rs.absolute(iT);
					stReturn = stReturn + "<tr>";
					...
					if (rs.getInt("nmLimit") <= 0) {
						stReturn = stReturn + "<td><input type=text name='t_"
						    + rs.getString("stTwitterId")
				...
				stReturn = stReturn
				    + "<tr><th colspan=2><input type=submit name=submit9 value='Send Twitter'></th></tr>";
			} else {
				stReturn = stReturn
				    + "tr><th colspan=2>ERROR: no twitter accounts</th></tr>";
			}
		} catch (Exception e) {
		...
		try {
			...
			for (int iR = 1; iR <= iMax; iR++) {
				...
				if (nmFieldFlags == rs.getInt("nmFieldFlags"))
					continue;
				stSql = "update teb_fields set nmFieldFlags=" + nmFieldFlags
				    + " where stDbFieldName=\"" + rs.getString("stDbFieldName") + "\";";
	...
	public String processEps8b() {
		...
		try {
			...
			for (int iR = 1; iR <= iMax; iR++) {
				...
				for (int iV = 2; iV < aV.length; iV += 2) {
					...
					try {
						ResultSet rs1 = this.ebEnt.dbDyn
						    .ExecuteSql("select * from dbeps2.teb_fields where stDbFieldName=\""
						        + aV[(iV + 1)] + "\" ");
						...
						stNewField = stNewField + "_" + rs1.getString("nmGrouping") + "_"
						    + rs1.getString("nmDataType");
						...
						int nmForeignId = this.ebEnt.dbDyn
						...
						if (nmForeignId <= 0) {
							this.stError = (this.stError
							    + "<BR>NOT FOUND stResponseStructure: [" + aV[(iV + 1)]
							    + "] " + stNewField);
						}
					} catch (Exception e) {
					}
				...
				this.ebEnt.dbDyn
				    .ExecuteUpdate("update teb_epsfields set stResponseStructure=\""
				        + stNew + "\" " + "where stDbFieldName=\""
			...
			for (int iR = 1; iR <= iMax; iR++) {
				...
				for (int iV = 2; iV < aV.length; iV += 2) {
					...
					try {
						...
						stNew = stNew + stNewField;
						if (nmForeignId <= 0) {
							this.stError = (this.stError + "<BR>NOT FOUND: [" + aV[(iV + 1)]
							    + "] " + stNewField);
						}
					} catch (Exception e) {
					}
				...
				this.ebEnt.dbDyn
				    .ExecuteUpdate("update teb_epsfields set stRequestStructure=\""
				        + stNew + "\" " + "where stDbFieldName=\""
				        + rs.getString("stDbFieldName") + "\" ");
			}
		} catch (Exception e) {
	...
	public static int[] getEpsDataType(String stDt) {
		...
		if ((stDt.equals("Drop-Down List")) || (stDt.equals("Drop Down List"))
		    || (stDt.equals("Check Boxes"))) {
			aiReturn[0] = 9;
