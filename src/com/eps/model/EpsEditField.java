...
public class EpsEditField
{
  ...
  public String makeLaborCategories(ResultSet rsFields, String stValue, ResultSet rsD)
  {
    String stReturn = "";
    try
    {
      ResultSet rsC = this.ebEnt.dbDyn.ExecuteSql("SELECT LaborCategory FROM teb_reflaborcategory rlc, laborcategory lc"
        + " where rlc.nmRefType=42 and rlc.nmLaborCategoryId = lc.nmLcId"
        + " and rlc.nmRefId=" + rsD.getString("nmUserId") + " order by LaborCategory");
      rsC.last();
    ...
    {
      stReturn += "<BR>ERROR makeLaborCategories: " + e;
    }
    return stReturn;
  }
  ...
  public String getMulitUsers(String stChild, int iF, String stExtraFieldName, String stValue, String stLc)
  {
    ...
    stEdit += "</td><td valign=top>";
    stEdit += "<input type=image border=0 src='./images/stickman2.png' alt='Select Users' class=imageStyle"
      + " onClick='return getPopupValue4(this.form." + stId + stExtraFieldName + ",this.form." + stId + ",1,\"" + stValue + "\",\"" + stLc + "\");'>"
      + "<input type=image border=0 src='./images/stickman2.png' alt='Select Users' class=imageStyle"
