...
public class EpsEditField {
	...
	public String editField(ResultSet rsMyDiv, ResultSet rsTable,
		...
		try {
			...
			// if ( (iFlags & 2) != 0 ||
			// rsFields.getString("stValidationFlags").length() > 0 )
			{
				this.giNrValidation++;
	...
	public String makeProjectReqMap(ResultSet rsF, String stValue, ResultSet rsD) {
		/*
		 * 54 varchar Req mapping task ids 55 varchar MappingProjectPercent 56
		 * varchar MappingProjectExternalPrj
		 */
