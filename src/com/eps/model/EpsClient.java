...
{
  public String stVersion = "Version: 4/11/12 07:49AM";
...
//        stReturn += "<li><a href='./?stAction=runeob&commtrace=i'>Run EOB now</a></li>";
        stReturn += "<li><a href='./?stAction=loadpage&m="+java.net.URLEncoder.encode("End-of-Business Processing")+"&r="+java.net.URLEncoder.encode("./?stAction=runeob&commtrace=i")+"'>Run EOB now</a></li>";
        stReturn += "</ul></li>";
      }
    } catch (Exception e)
    {
